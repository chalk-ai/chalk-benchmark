...
func init() {
	...
	flags.StringVar(&inputCompression, "input_compression", parse.DefaultInputCompression, "Arrow IPC codec for query inputs: 'uncompressed', 'lz4' or 'zstd'. Defaults to lz4 to match Chalk's Python gRPC client; pass 'uncompressed' to measure the raw transfer cost.")
